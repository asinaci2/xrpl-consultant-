...
import {
  ...
  ChevronLeft,
  ChevronRight,
} from "lucide-react"; // or your icon lib (heroicons, etc.)
...
export function AppSidebar() {
  ...
  return (
    <div
      className={cn(
        "relative h-screen border-r border-border bg-background/80 backdrop-blur-md transition-all duration-300 ease-in-out",
    ...
    >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute -right-4 top-6 z-10 rounded-full border bg-background shadow-md hover:bg-secondary/20"
          ...
          {!isCollapsed ? (
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium">Asi Naci</span>
                <span className="text-xs text-muted-foreground">@AsiNaci2</span>
              </div>
            </div>
          ) : (
